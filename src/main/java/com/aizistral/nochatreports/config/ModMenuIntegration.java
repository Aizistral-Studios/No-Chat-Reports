...
public final class ModMenuIntegration implements ModMenuApi {
	...
	public ConfigScreenFactory<?> getModConfigScreenFactory() {
		return screen -> {
			...
			visual.addEntry(entryBuilder.startIntSlider(Component.translatable("option.NoChatReports.verifiedIconOffsetX"), NCRConfig.getClient().verifiedIconOffsetX, -10, 10)
					.setDefaultValue(0)
			...
			visual.addEntry(entryBuilder.startIntSlider(Component.translatable("option.NoChatReports.verifiedIconOffsetY"), NCRConfig.getClient().verifiedIconOffsetY, -10, 10)
					.setDefaultValue(0)
